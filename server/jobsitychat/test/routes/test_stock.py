...
def mock_session_committer_stock(func):
...
with mock.patch('jobsitychat.libraries.hooks.session_committer', mock_session_committer_stock):
    from jobsitychat.routes import stock
